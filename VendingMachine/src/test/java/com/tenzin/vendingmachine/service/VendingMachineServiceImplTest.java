...
public class VendingMachineServiceImplTest {
    ...
    public void calculateChange() {
        ...
        assertEquals(8, mapForChange.values().toArray()[1], "Number of quarters should be 8");
        assertEquals(0, mapForChange.values().toArray()[2], "Number of quarters should be 8");
        assertEquals(1, mapForChange.values().toArray()[3], "Number of cent should be 1");
    }
