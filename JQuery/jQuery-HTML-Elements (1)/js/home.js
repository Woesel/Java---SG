$(document).ready(function () {
    ...
    // //Add a paragraph element containing your name and email to the footer. The text must be in 
    // //Courier font and be 24 pixels in height.
    $(".footer").html("<p>Tenzin Woesel  Email: tenwoes@gmail.com</p>").css({"font-family": "Courier", "font-size": "24px"});
});