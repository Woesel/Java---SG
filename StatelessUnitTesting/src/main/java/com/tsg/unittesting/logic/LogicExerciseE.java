    ...
    public static String whatColor(int waveLengthNM, int frequencyTHZ, double photonicEnergyEV) {
        ...
        if (color != null) {
            if ((waveLengthNM >= 380 && waveLengthNM <= 450) && (frequencyTHZ >= 668 && frequencyTHZ <= 789) && (photonicEnergyEV >= 2.75 && photonicEnergyEV <= 3.26)) {
                color = "Violet";
                return color;
            } else if ((waveLengthNM >= 450 && waveLengthNM <= 495) && (frequencyTHZ >= 606 && frequencyTHZ <= 668) && (photonicEnergyEV >= 2.50 && photonicEnergyEV <= 2.75)) {
                color = "Blue";
                return color;
            } else if ((waveLengthNM >= 495 && waveLengthNM <= 570) && (frequencyTHZ >= 526 && frequencyTHZ <= 606) && (photonicEnergyEV >= 2.17 && photonicEnergyEV <= 2.50)) {
                color = "Green";
                return color;
            } else if ((waveLengthNM >= 570 && waveLengthNM <= 590) && (frequencyTHZ >= 508 && frequencyTHZ <= 526) && (photonicEnergyEV >= 2.10 && photonicEnergyEV <= 2.17)) {
                color = "Yellow";
                return color;
            } else if ((waveLengthNM >= 590 && waveLengthNM <= 620) && (frequencyTHZ >= 484 && frequencyTHZ <= 508) && (photonicEnergyEV >= 2.00 && photonicEnergyEV <= 2.10)) {
                color = "Orange";
                return color;
            } else if ((waveLengthNM >= 620 && waveLengthNM <= 750) && (frequencyTHZ >= 400 && frequencyTHZ <= 484) && (photonicEnergyEV >= 1.65 && photonicEnergyEV <= 2.00)) {
                color = "Red";
                return color;
            }
        }
