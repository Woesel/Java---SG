...
public class VendingMachineServiceImplTest {
    ...
    public void calculateChange() {
        ...
        //ARRANGE
        VendingMachineItems testClone = new VendingMachineItems("KurKure", new BigDecimal("3.99"), 10);
        //ACT
...
//        System.out.println(mapForChange);
        assertEquals(4, (int) mapForChange.get(ChangeAmounts.QUARTER));
        assertEquals(0, (int) mapForChange.get(ChangeAmounts.DIME));
        assertEquals(0, (int) mapForChange.get(ChangeAmounts.NICKEL));
        assertEquals(1, (int) mapForChange.get(ChangeAmounts.CENT));
    }
