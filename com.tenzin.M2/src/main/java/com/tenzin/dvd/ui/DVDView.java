...
public class DVDView {
    ...
    public DVD getNewDVDInfo() {
        ...
        String releaseDate = io.readString("Please enter the release date for DVD in the format MM-dd-yyyy.");
        ...
        LocalDate releasedDate = LocalDate.parse(releaseDate, DateTimeFormatter.ofPattern("MM-dd-yyy"));
        
        currentDVD.setReleaseDate(releasedDate);
    ...
    public void displayParticularDVDInformation(DVD dvd) {
        if (dvd != null) {
            ...
            io.print("Release Date: " + dvd.getReleaseDate().format(DateTimeFormatter.ofPattern("MM/dd/yyy")));
        ...
        do {
            ...
            switch (menuSelection) {
                case 1:
                    ...
                    LocalDate releasedDate = LocalDate.parse(releaseDate, DateTimeFormatter.ofPattern("MM-dd-yyyy"));
                    DVDToEdit.setReleaseDate(releasedDate);
                    break;
                case 2:
                    String MPAARating = io.readString("Enter the MPAARating for the DVD.");
